...
traitor-role-greeting =     Вы агент Синдиката.
    ...
    Смерть NanoTrasen!
traitor-role-codewords =     Кодовые слова: { $codewords }.
