...
action-description-carp-rift = Призывает карповый разлом, который периодически спавнит карпов.
 Призывает карповый разлом, который периодически спавнит карпов.
...
carp-rift-destroyed = Разлом был уничтожен! Теперь вы временно ослаблены.
 Разлом был уничтожен! Теперь вы временно ослаблены.
dragon-round-end-summary = Драконами были:
dragon-round-end-dragon =     { $name } с { $count } { $count ->
        [one] разломом
        [few] разломами
       *[other] разломами
    }
dragon-round-end-dragon-player =     { $name } ({ $player }) с { $count } { $count ->
        [one] разломом
        [few] разломами
       *[other] разломами
    }
