...
alert-level-blue-announcement = Подтверждена неизвестная угроза станции. Служба безопасности может проводить выборочные обыски. Членам экипажа рекомендуется быть бдительными и сообщать о подозрительной деятельности соответствующему отделу.
alert-level-red = Красный
alert-level-red-announcement = Присутствует прямая угроза для станции. Служба безопасности должна быть готова применять летальную силу по необходимости. Члены экипажа должны укрыться в безопасном месте, и следовать указаниям, отдаваемым действующей властью.
...
alert-level-white-announcement = Уровень Глиммера приближается к опасному уровню. Необходимо произвести отключение всех исследоватьльских зондов Глиммера. Ищите защиту от псионического воздействия. Псионикам следует немедленно пройти процедуру псионического избавления или големинезацию. Допустимо насильственное применение обоих методов.
...
alert-level-epsilon-announcement = Центральное командование объявило на станции уровень угрозы "Эпсилон". Все контракты были расторгнуты.
