...
mind-component-no-mind-and-dead-text = { CAPITALIZE(SUBJECT($ent)) } { CONJUGATE-BE($ent) } dead, and { SUBJECT($ent) } { CONJUGATE-BASIC($ent, "have", "has") } already completed { POSS-ADJ($ent) } journey to whatever is next.
